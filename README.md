# HEREMAP
A framework to simplify use of HERE Maps, which a bunch of high level functions.
In additiopnal, allows use of Geocoding and routing with Node.js
...
<dt><a href="#heremap_setZoom">heremap:setZoom(zoom)</a></dt>
...
<dd><p>compute a route with optional waypooints. [see more info on optional parameters] (<a href="http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf">http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf</a>)</p>
</dd>
<dt><a href="#hm_isoline">hm:isoline(opt)</a> ⇒ <code>object</code></dt>
<dd><p>compute an isoline. [see more info on optional parameters] (<a href="http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf">http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf</a>)</p>
</dd>
<dt><a href="#hm_matrix">hm:matrix(source, dest, opt)</a> ⇒ <code>object</code></dt>
<dd><p>compute a matrix. [see more info on optional parameters] (<a href="http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf">http://documentation.developer.here.com/pdf/routing_hlp/7.2.100/Routing%20API%20v7.2.100%20Developer&#39;s%20Guide.pdf</a>)</p>
<p>Matrix size is limited to 1x100,100X1 or 15*N</p>
</dd>
